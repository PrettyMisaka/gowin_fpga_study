...
//--------Copy here to design--------
    ...
    Gowin_DPB_128_2048 your_instance_name(
        .douta(douta_o), //output [127:0] douta
        .doutb(doutb_o), //output [127:0] doutb
        ...
        .dina(dina_i), //input [127:0] dina
        .adb(adb_i), //input [10:0] adb
        .dinb(dinb_i) //input [127:0] dinb
    );
